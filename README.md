...
### Hi, I'm Amaury!👏
I am an Architect (Security & DevSecOps Support) with over 11 years of experience in IT, specializing in Information Security for Cloud environments. Currently, I serve as a Cloud Security Expert at CI&T, supporting Growth Units (Business Units). I have a strong understanding of regulatory standards like GDPR and SOC 2, ensuring compliance and security best practices in cloud solutions, reporting to the Security Exec, I work closely with the Developers and Infrastructure teams to ensure security is deeply integrated across the cloud development lifecycle. To discuss further, please connect with me on my [LinkedIn](https://www.linkedin.com/in/amaurybsouza/).
